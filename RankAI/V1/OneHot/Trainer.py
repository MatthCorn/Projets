from RankAI.V1.OneHot.Ranker import Network, ChoseOutput
from RankAI.V1.OneHot.DataMaker import MakeData
...
if save:
    ...
    save_path = os.path.join(local, 'RankAI', 'Save', 'V1', 'OneHot', folder)
################################################################################################################################################

param = {'n_encoder': 3,
         'path_ini': None,
         # 'path_ini': os.path.join('RankAI', 'Save', 'V1', 'OneHot', 'XXXXXXXXXX', 'ParamObs.pkl'),
         'len_in': 10,
         'len_out': 5,
         'd_in': 10,
         'd_att': 64,
...
ValidationInput, ValidationOutput = MakeData(NInput=NInput, NOutput=NOutput, DVec=DVec, std=1, NData=NDataV, WeightCut=WeightCut, WeightSort=WeightSort)
...
TrainingInput, TrainingOutput = MakeData(NInput=NInput, NOutput=NOutput, DVec=DVec, std=1, NData=NDataT, WeightCut=WeightCut, WeightSort=WeightSort)
