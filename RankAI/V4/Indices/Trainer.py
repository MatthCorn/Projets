from RankAI.V4.Indices.Ranker import Network, ChoseOutput
from RankAI.V4.Indices.DataMaker import MakeData
...
if save:
    ...
    save_path = os.path.join(local, 'RankAI', 'Save', 'V4', 'Indices', folder)
################################################################################################################################################

param = {'n_encoder': 1,
         'path_ini': None,
         # 'path_ini': os.path.join('RankAI', 'Save', 'V4', 'Indices', 'XXXXXXXXXX', 'ParamObs.pkl'),
         'len_in': 10,
         'len_out': 5,
         'd_in': 10,
         'd_att': 64,
...
ValidationInput, ValidationOutput = MakeData(NInput=NInput, NOutput=NOutput, DVec=DVec, sigma=1, NData=NDataV, WeightF=WeightF, WeightN=WeightN)
...
TrainingInput, TrainingOutput = MakeData(NInput=NInput, NOutput=NOutput, DVec=DVec, sigma=1, NData=NDataT, WeightF=WeightF, WeightN=WeightN)
