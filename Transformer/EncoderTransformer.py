...
class EncoderLayer(nn.Module):
    def __init__(self, d_model, d_att, num_heads, WidthsFeedForward=[512], max_len=64, MHADropout=0.1, FFDropout=0.1, masked=False):
        super().__init__()
        self.MultiHeadAttention = RMHSA(d_model, d_att, num_heads, max_len=max_len, dropout=MHADropout, masked=masked)
