...
# Dans cette version, on tente de rendre l'objet plus souple en autorisant x_latent à avoir des longueurs de séquence variable (mais bornée)
# Il fera dans l'idée extactement les mêmes calculs que RelativeMultiHeadCrossAttentionFixed si cette longueur ne varie pas entre batchs.
