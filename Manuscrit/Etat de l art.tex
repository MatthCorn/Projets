...
\paragraph{Mécanisme d'interaction : Filtrage local et expansion hiérarchique}
...
\paragraph{Mécanisme d'interaction : Récurrence et Mémoire d'État}
...
\begin{align*}
	q_4 &= x_4 W^Q, & k_j &= x_k W^K, & v_i &= x_i W^V \\
