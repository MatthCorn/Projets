...
\include{COMPOSITION GENERALE et CHARTE GRAPHIQUE}

\include{INFORMATIONS GENERALES SUR LA PAGE DE COUVERTURE}

\include{CIVILITE FEMINISATION DES TITRES ET FONCTIONS}

\include{PRESENTATION DE LA DIRECTION DE LA THESE OU DE L EQUIPE D ENCADREMENT}

\include{COMPOSITION DU JURY}

\include{BIEN CITER SES SOURCES}

\include{DEPOSER ET DIFFUSER SA THESE}

\include{ANNEXE LES LOGOS INSTITUTIONNELS}
