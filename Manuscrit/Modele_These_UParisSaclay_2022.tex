...
\renewcommand{\bottomfraction}{0.7}   % Autorise les images à occuper 70% du bas de page
\renewcommand{\textfraction}{0.15}    % Demande seulement 15% de texte minimum par page
\renewcommand{\floatpagefraction}{0.6}% Une page isolée n'est créée que si l'image occupe au moins 60% de l'espace
