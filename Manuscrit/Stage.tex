...
Dans l'approche globale Seq2Seq, les données encodaient le temps d'arrivée relativement à la position dans la séquence afin d'éviter la croissance incontrôlée des valeurs \ref{seq:timeencoding}. Cependant, dans l'approche flux-à-flux où les traitements des éléments ont vacation à être réalisé de manière locale, la pertinence de cet encodage est remise en question.
