...
\end{center}
\caption{Illustration de la chaînes de transformation des informations dans l'environnement numérique, extraite de la figure \ref{fig:env2}. L'encadré rouge localise le bloc DCI.}
\label{fig:DNApb}
\end{figure}
