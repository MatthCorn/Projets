...
Ce processus global intègre les contraintes matérielles du capteur, tel que le nombre de pistes simultanées maximal $N_{max}$ ou le seuil d'association aux pistes $\delta f$, et il est formalisé par l'Algorithme \ref{algo:capteur_process}. 
