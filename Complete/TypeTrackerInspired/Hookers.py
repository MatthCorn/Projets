...
class Hookers():
    ...
    def SymetryTrackers(self, module, input, output):
        ...
        # output.shape = (batch_size, len_target, n_trackers, d_att)
        shape = output.shape
    ...
    def VarianceTrackers(self, module, input, output):
        ...
        input = input[0]
        # input.shape = (batch_size*len_target, n_trackers, d_att)
        shape = input.shape
    ...
    def DiversityDecision(self, module, input, output):
        ...
        # output.shape = (batch_size, len_target, n_trackers, 1)
        diversity_score = torch.norm(torch.var(output, dim=(0, 1)))/math.sqrt(self.model.n_trackers)
