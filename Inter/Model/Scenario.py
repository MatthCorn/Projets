...
class Simulator:
    def __init__(self, n, N, dim, sensitivity_fourier=0.2, sensitivity_sensor=0.1, seed=None):
        self.n = n
        self.N = N
        self.dim = dim
        self.T = 0
...
if __name__ == '__main__':
    ...
    df = 0.2
    dF = 0.1
    S = Simulator(5, 30, 4, sensitivity_fourier=df, sensitivity_sensor=dF, seed=None)
    S.Run()
