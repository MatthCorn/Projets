...
ValidationInput, ValidationOutput, _ = MakeData(NVec=5, DVec=DVec, sigma=1, NData=NDataV, ShiftInterval=[Min, Max], type=type, weights=weights, device=device)
...
for ShiftInterval in ShiftIntervals:
    TrainingInput, TrainingOutput, _ = MakeData(NVec=5, DVec=10, sigma=1, NData=NDataT, type=type, ShiftInterval=ShiftInterval, weights=weights, device=device)
    ...
    Input, Output, Shift = MakeData(NVec=5, DVec=10, sigma=1, NData=10000, type=type, ShiftInterval=[Min, Max], weights=weights, device=device)
