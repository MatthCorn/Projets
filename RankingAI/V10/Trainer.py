...
N = Network(n_encoder=10, len_in=10, len_latent=5, d_in=10, d_att=64, WidthsEmbedding=[32], n_heads=4, norm='post')
...
ValidationInput, ValidationOutput = MakeData(NInput=10, DVec=DVec, sigma=1, NData=NDataV, WeightsCut=WeightsCut, WeightsSort=WeightsSort, LenOut=5)
...
TrainingInput, TrainingOutput = MakeData(NInput=10, DVec=10, sigma=1, NData=NDataT, WeightsCut=WeightsCut, WeightsSort=WeightsSort, LenOut=5)
