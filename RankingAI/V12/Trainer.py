from RankingAI.V12.Ranker import Network
from RankingAI.V12.DataMaker import MakeData
...
if save:
    ...
    save_path = os.path.join(local, 'RankingAI', 'Save', 'V12', folder)
    os.mkdir(save_path)
################################################################################################################################################
...
ValidationInput, ValidationOutput = MakeData(NInput=NInput, DVec=DVec, sigma=1, NData=NDataV, WeightsF=WeightsF)
...
TrainingInput, TrainingOutput = MakeData(NInput=NInput, DVec=DVec, sigma=1, NData=NDataT, WeightsF=WeightsF)
